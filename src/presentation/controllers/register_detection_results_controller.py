...
class RegisterDetectionResultsController(RouteInterface):
    ...
    def route(self, http_request: Type[HttpRequest]) -> HttpResponse:
        ...
        if http_request.body:
            ...
            if "user_input_id" in body_params and "number_fps" in body_params and "confidence" in body_params and "image_base64" in body_params:
                ...
                response = self.register_detection_results.register(
                    user_input_id=user_input_id, number_fps=number_fps, confidence=confidence, 
                )
